...
As an active browser of the r/nba subreddit, I found that the Sentiment Analysis results for some players were more or less reasonable. For example, players like Patrick Beverly and Kyrie Irving having negative scores made sense, as Beverly has an infamous reputation for being scrappy and "dirty", while Kyrie Irving has been especially disliked in the last year with his avoidance of the covid vaccine. Star players like Stephen Curry, Lebron James, and Kevin Durant all being around average also made sense. Superstars have vocal fans and haters alike, so while they get high praise after good games, they also get hated on when they play poorly.
